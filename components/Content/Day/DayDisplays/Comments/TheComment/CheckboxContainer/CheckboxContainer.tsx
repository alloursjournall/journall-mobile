...
// <>
import { View, Dimensions, Text, TextInput, Image, StyleSheet, TouchableOpacity } from 'react-native';
...
import { StarIcon, SoundIcon, RedBackArrowIcon, ThoughtsIcon, MasqueradeIcon, UnlockIcon, LockIcon } from '@/constants/Images';
...
const CheckboxContainer: React.FC<CheckboxContainerProps> = ({
    ...
    const { submitTextComment, submitSoundCommentThought, returnProfileImg } = useContentFunction();

    const CURRENT_USER = useSelector((state: RootState) => state.currentUser.CURRENT_USER);

    const [showUnlockDropdownMenu, setShowUnlockDropdownMenu] = useState<boolean>(false);
    const [showLockDropdownMenu, setShowLockDropdownMenu] = useState<boolean>(false);
    ...
    const handleCheck = (type: string) => {
        ...
        if (type === 'nonAnonymous') {
            setNewCommentNonAnonymous(newCommentNonAnonymous === 'yes' ? 'no' : 'yes');
        }
        if (type === 'thoughtsOk') {
    ...
    const submitCommentFunc = async () => {
        console.log('I see you clicking you heard');
        console.log('voiceCommentClick', voiceCommentClick);
    ...
    return (
        <View style={styles.cont}>
            ...
            <View style={styles.row}>
                <View style={styles.leftSideRow}>
                    ...
                    {newCommentNonAnonymous === 'yes' ? (
                        <Image style={[{ borderRadius: 50 }, styles.icon]} source={returnProfileImg(CURRENT_USER?.id, allUserProfileIcons)} />
                    ) : (
                ...
                <TouchableOpacity
                    style={[{ backgroundColor: newCommentNonAnonymous === 'no' ? 'grey' : 'transparent' }, styles.button]}
            ...
            <View style={styles.row}>
                ...
                <TouchableOpacity
                    style={[{ backgroundColor: newCommentThoughtsOk === 'yes' ? 'grey' : 'transparent' }, styles.button]}
                    onPress={() => handleCheck('thoughtsOk')}
                />
            </View>

            {newCommentThoughtsOk !== 'no' && newCommentThoughtsOk !== 'no' && (
                // day?.thoughts_ok !== "no" && newCommentThoughtsOk !== 'no' && newCommentThoughtsOk !== "no" &&
                <View style={styles.column}>
                    <View style={styles.row}>
                        ...
                        <TouchableOpacity
                            style={[{ backgroundColor: newCommentTextOk === true ? 'grey' : 'transparent' }, styles.button]}
                    ...
                    <View style={styles.row}>
                        ...
                        <TouchableOpacity
                            style={[{ backgroundColor: newCommentVoiceOk === true ? 'grey' : 'transparent' }, styles.button]}
                    ...
                    <View style={styles.row}>
                        ...
                        <TouchableOpacity
                            style={[{ backgroundColor: newCommentStarrable === 'yes' ? 'grey' : 'transparent' }, styles.button]}
            ...
            {day?.anonymous_comments_ok && newCommentThoughtsOk !== 'no' && (
                <View style={styles.row}>
                    <View style={styles.leftSideRow}>
                    ...
                    <TouchableOpacity
                        style={[{ backgroundColor: anonymousCommentsOk === true ? 'grey' : 'transparent' }, styles.button]}
                        onPress={() => handleCheck('anonymousCommentsOk')}
                    />
                </View>
            )}

            {day?.starrable !== 'no' && newCommentStarrable !== 'no' && newCommentThoughtsOk !== 'no' && (
                <View style={styles.column}>
                    <View style={styles.row}>
                        <View style={styles.leftSideRow}>
                            <Text> show avg </Text>
                        ...
                        <TouchableOpacity
                            style={[{ backgroundColor: newCommentStarsShowAvg === true ? 'grey' : 'transparent' }, styles.button]}
                    ...
                    <View style={styles.row}>
                        ...
                        <TouchableOpacity
                            style={[{ backgroundColor: newCommentStarsShowUsers === true ? 'grey' : 'transparent' }, styles.button]}
            ...
            {showLockDropdownMenu && newCommentNonAnonymous !== 'no' && (
                <View style={styles.lockRow}>
                    <View style={styles.leftSideRow}>
                        ...
                        <Image style={[{ borderRadius: 50 }, styles.icon]} source={MasqueradeIcon} />
                        <Image style={[{ borderRadius: 50 }, styles.icon]} source={returnProfileImg(CURRENT_USER?.id, allUserProfileIcons)} />
                    </View>

                    <TouchableOpacity
                        style={[{ backgroundColor: newCommentLock === 'reveal profile' ? 'grey' : 'transparent' }, styles.button]}
            ...
            {showLockDropdownMenu && newCommentStarrable !== 'no' && (
                <View style={styles.lockRow}>
                    ...
                    <TouchableOpacity
                        style={[{ backgroundColor: newCommentLock === 'stars show avg' ? 'grey' : 'transparent' }, styles.button]}
            ...
            {showLockDropdownMenu && newCommentStarrable !== 'no' && (
                <View style={styles.lockRow}>
                    ...
                    <TouchableOpacity
                        style={[{ backgroundColor: newCommentLock === 'stars show users' ? 'grey' : 'transparent' }, styles.button]}
            ...
            {showUnlockDropdownMenu && newCommentStarrable !== 'no' && (
                <View style={styles.lockRow}>
                    ...
                    <TouchableOpacity
                        style={[{ backgroundColor: newCommentUnlock === 'submit ⭐️' ? 'grey' : 'transparent' }, styles.button]}
            ...
            {showUnlockDropdownMenu && newCommentStarrable !== 'no' && (
                <View style={styles.lockRow}>
                    ...
                    {starsOrAverageNum ? (
                        <Text style={styles.addCommentInputText}> {starsOrAverageNum} times starred ⭐️ </Text>
                    ) : (
                    ...
                    <TouchableOpacity
                        style={[{ backgroundColor: newCommentUnlock?.includes('times') ? 'grey' : 'transparent' }, styles.button]}
            ...
            {showUnlockDropdownMenu && newCommentStarrable !== 'no' && (
                <View style={styles.lockRow}>
                    ...
                    {starsOrAverageNum ? (
                        <Text style={styles.addCommentInputText}> {starsOrAverageNum} avg stars ⭐️ </Text>
                    ) : (
                    ...
                    <TouchableOpacity
                        style={[{ backgroundColor: newCommentUnlock?.includes('avg') ? 'grey' : 'transparent' }, styles.button]}
