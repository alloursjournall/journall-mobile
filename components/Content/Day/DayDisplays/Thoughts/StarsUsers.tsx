...
interface PostingUserStars {
    ...
    postingUserStarsOrStarsUsers: string
    setPostingUserStarsOrStarsUsers: any,
...
const StarsUsers: React.FC<PostingUserStars> = ({
    day, currThought, postingUserThoughts, postingUserStarsOrStarsUsers, postingUserThoughtStars,
    setPostingUserStarsOrStarsUsers, usersPassLocks, setUsersPassLocks, allUserProfileIcons
}) => {

    const goBackToPostingUserStars = () => {
        setPostingUserStarsOrStarsUsers('postingUserStars');
    }
        ...
        <View style={styles.starsCont}>
            <TouchableOpacity style={styles.buttonCont} onPress={goBackToPostingUserStars}>
                ...
                <ScrollView contentContainerStyle={styles.starsMap}>
                    ...
                    {
                        Array.isArray(postingUserThoughtStars) &&
                        postingUserThoughtStars?.map((mapitem: any, index: number) => {
                            return (
                                <StarsRatings
                                    mapitem={mapitem}
                                    index={index}
