...
const FieldConstantseeDecideBarEdit: React.FC<props> = ({ editDay, setEditDay, fieldsBinIndex, setFieldsBinIndex }) => {
    const test = () => {};

    const decrementFieldsBin = () => {
        const dayMomentsLength = editDay?.fields?.fields?.length;
        if (fieldsBinIndex === 0) {
...
export default FieldConstantseeDecideBarEdit;
