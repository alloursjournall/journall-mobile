...
const EventMainRootCommentInputBar: React.FC<props> = ({
  ...
  return (
    ...
    //                 <Image style={styles.showCommentIconRowIcon} source={RedBackArrowIcon} />
    //                 </TouchableOpacity>

    //                 { dayHasThoughts && <Image style={styles.showCommentIconRowIcon} source={ThoughtsIcon} /> }
    //                 { dayHasMoments && <Image style={styles.showCommentIconRowIcon} source={MomentsIcon} /> }
    //                 { dayHasFields && <Image style={styles.showCommentIconRowIcon} source={FieldsIcon} /> }
    //                 { dayHasGreatfull && <Image style={styles.showCommentIconRowIcon} source={GreatfullIcon} /> }
